    ...
    form.addEventListener('submit', function (ev) {
      ...
      fetch(form.action, { method: 'POST', body: new FormData(form), headers: { Accept: 'application/json' } })
        .then(function (r) {
          ...
          else { status.textContent = 'Het versturen is niet gelukt. Mail gerust rechtstreeks naar info@synomic.nl.'; }
        })
        .catch(function () { status.textContent = 'Het versturen is niet gelukt. Mail gerust rechtstreeks naar info@synomic.nl.'; });
    });
  }
});
